...
# === Parametreler ===
FOLDER_PATH = r"C:\Users\selin\OneDrive\Masaüstü\improving"
FILE_COUNT = 42
TOLERANCE = 240

# === Genel istatistik değişkenleri ===
total_correct = 0
total_coughs = 0
precision_list = []
...
for file_index in range(1, FILE_COUNT + 1):
    ...
    try:
        ...
        pulmonary_signal = pulmonary_df.iloc[:, 0] # İlk sütunu al
    ...
    try:
        ...
        pulmonary_full_column = pulmonary_signal.iloc[:, 0]
    ...
    # Sütunları çekelim 
    pulmonary_data = pulmonary_df.iloc[:, 0]    # 1. Sütun (A)
